...
# root = Tk()
# root.config(background='#3366ff')
# root.geometry("350x500+300+50")
# root.resizable(False, False)
# root.title("PassWord Generator")

# title = Label(text="Strong Password Generator", bg="#0000ff",font=("roboto", 16, "bold"), fg="white")
# title.place(x=0, y=0, height=70, relwidth=1)

# search_label = Label(text="length").place(x=160,y=100)
